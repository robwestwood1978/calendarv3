// frontend/src/google/oauth.ts (updated)
// OAuth 2.0 Authorization Code w/ PKCE for Google
// Supports secretless PKCE and confidential (client_secret) flows.
// Reads optional secret from VITE_GOOGLE_CLIENT_SECRET or localStorage.fc_google_client_secret.
